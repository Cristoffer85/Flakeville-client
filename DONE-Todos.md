...
* Product Management error when entering, also CRUD doesnt work in frontend. 
        - Backend works just fine in postman so 100% frontend issue. Cause was mismatch between backend "id" and frontend "Id". How petty huh? But thats often how small the errors actually are. You just have to be thourough.
---------------------------
